...
//                 {type !== "list" &&
//                     <>
//                         <h1 className='headerTitle'>a life time discount?its genius</h1>
//                         <p className='headerDesc'>get award
//                         </p>
...
//                                 }} className='headerSearchText'>{`${options.adult} adult . ${options.children} . ${options.room} room`}</span>
